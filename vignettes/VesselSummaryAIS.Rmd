...
The `operatingtime` function  analyzes the cumulative operational time of each distinct ship and ship type. Users can set the speed threshold with the parameter `activityspeed` to define the operation mode. The default speed is 3 knots (meaning only the activity with speed of over 3 knots will be considered as operation mode).
