...
#' @examples speeddist(AISdata, studyship = 'Fishing', maxLON = -94.5, minLON = -95, maxLAT = 30, minLAT = 29)
speeddist <- function(AISdata, studyship = 'Cargo', maxLON = -94.5, minLON = -95, maxLAT = 30, minLAT = 29){
  # Check studyship
